...
SU Remote is a fresh implementation of the server and viewers. It does not link to or copy the previous GPL macVNC/LibVNCServer implementation.
...
- **ZeroTier One**, installed separately by the user, is controlled through its authenticated local service API. SU Remote does not embed or redistribute its networking engine. ZeroTier is a trademark of its respective owner.
